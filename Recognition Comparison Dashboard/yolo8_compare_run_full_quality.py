...
BASE_DB_DIR = "/Users/idohasson/Downloads/4TH-Year-Project/DB"
...
for folder_name in SUB_FOLDERS:
    ...
    for filename in os.listdir(folder_path):
        if filename.lower().endswith(('.png', '.jpg', '.jpeg')):
            ...
            try:
                # עודכן לשם הטבלה הנכון: google_lens_eval
                response = supabase.table("google_lens_eval").insert(data).execute()
